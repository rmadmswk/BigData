...
DROP USER c##CAKD5 CASCADE;
CREATE USER c##CAKD5 IDENTIFIED BY CAKD5 DEFAULT TABLESPACE users TEMPORARY TABLESPACE temp PROFILE DEFAULT;
GRANT CONNECT, RESOURCE TO c##CAKD5;
GRANT CREATE VIEW, CREATE SYNONYM TO c##CAKD5;
GRANT UNLIMITED TABLESPACE TO c##CAKD5;
ALTER USER c##CAKD5 ACCOUNT UNLOCK;
